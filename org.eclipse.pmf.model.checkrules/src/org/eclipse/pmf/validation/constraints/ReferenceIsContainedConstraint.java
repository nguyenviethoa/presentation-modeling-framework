...
public class ReferenceIsContainedConstraint extends AbstractModelConstraint{
	...
	public IStatus validate(IValidationContext ctx) {
		...
		context.put(EValidator.SubstitutionLabelProvider.class, new LabelProviderForConstraints());
		...
		if (eType == EMFEventType.NULL) {
			...
			dc.getMessage();
				if (!PMFValidator.INSTANCE.validate_EveryReferenceIsContained(pmfObj, dc, context)) {
					return ctx.createFailureStatus(
							DiagnosticUtil.getErrorMessageFrom(dc));
				}
			}
