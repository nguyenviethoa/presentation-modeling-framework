 ...
 * <ul>
 *   <li>{@link model.impl.CompanyImpl#getEmployees <em>Employees</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompanyImpl extends MinimalEObjectImpl.Container implements Company {
	...
	public EList<Person> getEmployees() {
		if (employees == null) {
			employees = new EObjectContainmentEList<Person>(Person.class, this, ModelPackage.COMPANY__EMPLOYEES);
		}
		return employees;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.COMPANY__EMPLOYEES:
