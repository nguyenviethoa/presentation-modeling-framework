...
public class DataSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case DataPackage.DATA_MODEL_MANAGER: {
			DataModelManager dataModelManager = (DataModelManager) theEObject;
			T result = caseDataModelManager(dataModelManager);
			if (result == null)
		...
		case DataPackage.DATA_PROPERTY: {
			...
			if (result == null)
				result = casePMFObject(dataProperty);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.PROPERTY: {
			Property property = (Property) theEObject;
			T result = caseProperty(property);
			if (result == null)
				result = casePMFObject(property);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataPackage.TYPE_PARAMETER: {
			...
			if (result == null)
				result = casePMFObject(typeParameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
