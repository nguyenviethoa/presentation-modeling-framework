...
public class DatainputSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case DatainputPackage.DATA_INPUT: {
		...
		case DatainputPackage.SELECTION_INPUT: {
			SelectionInput selectionInput = (SelectionInput) theEObject;
			T result = caseSelectionInput(selectionInput);
			if (result == null)
				result = caseDataInput(selectionInput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DatainputPackage.FILE_INPUT: {
			FileInput fileInput = (FileInput) theEObject;
			T result = caseFileInput(fileInput);
			if (result == null)
				result = caseDataInput(fileInput);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Selection Input</em>'.
	 * <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Selection Input</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectionInput(SelectionInput object) {
		return null;
	}
