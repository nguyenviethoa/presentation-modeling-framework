...
/**
 * This is the item provider adapter for a {@link org.eclipse.pmf.pim.data.DataProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataPropertyItemProvider extends PMFObjectItemProvider implements
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataProperty_type_feature",
						"_UI_DataProperty_type"),
				DataPackage.Literals.DATA_PROPERTY__TYPE, true, false, true,
				null, null, null));
	}
	...
	protected void addManyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DataProperty_many_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataProperty_many_feature",
						"_UI_DataProperty_type"),
				DataPackage.Literals.DATA_PROPERTY__MANY, false, false, false,
	...
	protected void addMandatoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DataProperty_mandatory_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataProperty_mandatory_feature",
						"_UI_DataProperty_type"),
				DataPackage.Literals.DATA_PROPERTY__MANDATORY, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DataPackage.Literals.DATA_PROPERTY__GENERIC_TYPE);
		}
	...
	/**
	 * This returns DataProperty.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/DataProperty"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				DataPackage.Literals.DATA_PROPERTY__GENERIC_TYPE,
