...
/**
 * This is the item provider adapter for a {@link org.eclipse.pmf.pim.interactive.ConditionTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionTriggerItemProvider extends TriggerItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(InteractivePackage.Literals.CONDITION_TRIGGER__CONDITION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ConditionTrigger"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ConditionTrigger_type");
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				InteractivePackage.Literals.CONDITION_TRIGGER__CONDITION,
		...
		newChildDescriptors.add(createChildParameter(
				InteractivePackage.Literals.CONDITION_TRIGGER__CONDITION,
				InteractiveFactory.eINSTANCE.createExpressionCondition()));
