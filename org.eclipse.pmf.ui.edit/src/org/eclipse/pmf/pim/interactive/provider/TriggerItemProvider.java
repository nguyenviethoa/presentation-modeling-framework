...
/**
 * This is the item provider adapter for a {@link org.eclipse.pmf.pim.interactive.Trigger} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InteractivePackage.Literals.TRIGGER__ACTIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Trigger"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				InteractivePackage.Literals.TRIGGER__ACTIONS,
				InteractiveFactory.eINSTANCE.createTriggerAction()));

		newChildDescriptors.add(createChildParameter(
				InteractivePackage.Literals.TRIGGER__ACTIONS,
				InteractiveFactory.eINSTANCE.createSetAction()));

		newChildDescriptors.add(createChildParameter(
				InteractivePackage.Literals.TRIGGER__ACTIONS,
				InteractiveFactory.eINSTANCE.createClassHandlerAction()));
	}
