...
/**
 * This is the item provider adapter for a {@link org.eclipse.pmf.pim.DataItem} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DataItemItemProvider extends DataElementItemProvider implements
	...
	protected void addMandatoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_DataItem_mandatory_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DataItem_mandatory_feature", "_UI_DataItem_type"),
				PMFPackage.Literals.DATA_ITEM__MANDATORY, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PMFPackage.Literals.DATA_ITEM__LABEL);
			childrenFeatures.add(PMFPackage.Literals.DATA_ITEM__HELP);
			childrenFeatures.add(PMFPackage.Literals.DATA_ITEM__LAYOUT_DATA);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/DataItem"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				PMFPackage.Literals.DATA_ITEM__LABEL,
		...
		newChildDescriptors.add(createChildParameter(
				PMFPackage.Literals.DATA_ITEM__HELP,
				UiFactory.eINSTANCE.createText()));
		...
		newChildDescriptors.add(createChildParameter(
				PMFPackage.Literals.DATA_ITEM__LAYOUT_DATA,
