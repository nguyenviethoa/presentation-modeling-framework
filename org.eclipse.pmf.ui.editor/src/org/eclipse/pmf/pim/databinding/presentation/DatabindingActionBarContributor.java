...
/**
 * This is the action bar contributor for the Databinding model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DatabindingActionBarContributor extends
	 ...
	 * @generated
	 */
	public DatabindingActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("databinding-settings"));
		toolBarManager.add(new Separator("databinding-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				PmfEditorPlugin.INSTANCE
						.getString("_UI_DatabindingEditor_menu"),
				"org.eclipse.pmf.pim.databindingMenuID");
