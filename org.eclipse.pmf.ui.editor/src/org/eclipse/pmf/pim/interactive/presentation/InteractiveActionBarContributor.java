...
/**
 * This is the action bar contributor for the Interactive model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class InteractiveActionBarContributor extends
	 ...
	 * @generated
	 */
	public InteractiveActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("interactive-settings"));
		toolBarManager.add(new Separator("interactive-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				PmfEditorPlugin.INSTANCE
						.getString("_UI_InteractiveEditor_menu"),
				"org.eclipse.pmf.pim.interactiveMenuID");
