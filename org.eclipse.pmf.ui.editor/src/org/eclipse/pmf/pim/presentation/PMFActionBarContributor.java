...
/**
 * This is the action bar contributor for the PMF model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PMFActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	public PMFActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("pmf-settings"));
		toolBarManager.add(new Separator("pmf-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				PmfEditorPlugin.INSTANCE.getString("_UI_PMFEditor_menu"),
				"org.eclipse.pmf.pimMenuID");
